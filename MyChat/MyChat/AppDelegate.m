...
@property (strong, nonatomic) DiscoveryViewController *discoveryViewController;
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.charles.MyChat" in the application's documents directory.
...
- (void)initView{
    //init window with a tab bar view controller
    ...
    UINavigationController* chatNav = [[UINavigationController alloc] initWithRootViewController:self.chatViewController];
    UINavigationController* contactsNav = [[UINavigationController alloc] initWithRootViewController:
                                           self.contactsViewController];
    UINavigationController* discoveryNav = [[UINavigationController alloc] initWithRootViewController:
                                            self.discoveryViewController];
    UINavigationController* settingNav = [[UINavigationController alloc] initWithRootViewController:
                                         self.settingViewController];
    
    NSArray* controllers = [NSArray arrayWithObjects:chatNav, contactsNav, discoveryNav, settingNav, nil];
